...
public class pr extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter values for independent variables");

        jButton2.setText("View Covariance Matrix");
        ...
        jTextField2.setText("The combinations of dependant and independant variables are taken based on the covariance matrix");
...
if(zx.length!=dep.getSelectedItems().length)
    JOptionPane.showMessageDialog(null,"Enter values for all independent variables");
else{  
...
System.out.println("ggg="+pr1[i]);
}
String s="Predicted Value="+pr1[0];
